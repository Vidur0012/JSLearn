...
console.log("For Data 1 marksBMI > johnBMI : " + markHigherBMI1);
console.log("For Data 2 marksBMI > johnBMI : " + markHigherBMI2);
...
if (markHigherBMI1) {
    ...
    console.log(`John's (${johnBMI1}) is higher than Mark's BMI (${marksBMI1})`);
}

console.log("------For Data 2-------");
if (markHigherBMI2) {
    console.log(`Mark's BMI (${marksBMI2}) is higher than John's (${johnBMI2})`);
}
else {
    console.log(`John's (${johnBMI2}) is higher than Mark's BMI (${marksBMI2})`);
}
...
//Data (uncomment value you want)

const bill = 275;
// const bill = 40;
// const bill = 430;

const tipFactor = (bill >= 50 && bill <= 300) ? 0.15 : 0.20;

console.log(`The bill was ${bill}, the tip was ${tipFactor * bill}, and the total value ${bill + tipFactor * bill}`);
...
checkWinner(calcAverage(d1, d2, d3), calcAverage(k1, k2, k3));
...
console.log(tips);
const totals = tips.map((val, ind) => val + bills[ind]);
console.log(totals);
...
console.log("Average : "+calcAverageArr(totals1));
